        ...
        <div className="relative mx-auto flex min-h-[480px] max-w-7xl items-center px-6 py-20">
          ...
          >
            ...
            <h1 className="mt-6 text-5xl font-black leading-tight tracking-tight sm:text-6xl">
              Agricultural <span className="text-lime-400">Services</span>
            </h1>

            <p className="mt-6 text-lg text-slate-200 leading-8">
              End-to-end soil health analysis, bio-input application guidance, and sustainable crop nutrition programs designed for modern Indian agriculture.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black text-slate-900 sm:text-5xl">
              Scientific Soil & Crop Management
            </h2>
            <p className="mt-6 text-slate-600 leading-8 text-base">
              Urja provides on-farm technical advice, soil testing analysis, organic carbon restoration plans, and customized crop feeding schedules to ensure maximum crop yields and sustainability.
            </p>

            <div className="mt-8 space-y-4">
              {[
                "On-Site Soil & Water Sample Testing",
                "Customized Organic Fertilization Schedules",
                "Integrated Pest & Soil Health Management",
                "Guidance for Sugarcane, Vegetables, Fruit Crops & Grains",
              ].map((item, idx) => (
