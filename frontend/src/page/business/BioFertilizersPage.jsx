        ...
        <div className="relative mx-auto flex min-h-[480px] max-w-7xl items-center px-6 py-20">
          ...
          >
            ...
            <h1 className="mt-6 text-5xl font-black leading-tight tracking-tight sm:text-6xl">
              Bio Fertilizers & <span className="text-lime-400">Soil Care</span>
            </h1>

            <p className="mt-6 text-lg text-slate-200 leading-8">
              Enriching soil microbes, reviving organic carbon, and boosting crop resilience with eco-friendly bio-fertilizers.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-6 text-slate-600 leading-8 text-base">
              Urja Bio-Fertilizers contain active beneficial microorganisms that fix atmospheric nitrogen, solubilize phosphorus, and mobilize potassium, ensuring healthy crop nutrition while preserving soil biodiversity.
            </p>

            <div className="mt-8 space-y-4">
              {[
                "100% Organic & Non-Toxic Bio Formulation",
                "Fixes Nitrogen & Mobilizes Soil Minerals",
                "Enhances Water Holding Capacity in Soil",
                "Improves Root Development & Yield Potential",
            ...
            <div className="mt-10">
              ...
              >
                Inquire Bio-Fertilizer Bulk Supplies
          ...
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 shadow-2xl">
            <img
              src="https://www.urjafoods.net/wp-content/uploads/2021/08/fertbs-480x367.jpg"
              alt="Bio Fertilizers Soil Care"
