...
export default function SoyaProcessingPage() {
  return (
    <div className="bg-white text-slate-900">
      <section className="relative min-h-[480px] overflow-hidden bg-[#eff8e6]">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1615485290382-441e4d049cb5?auto=format&fit=crop&w=1800&q=90"
            alt="Soya Processing"
        ...
        <div className="relative mx-auto flex min-h-[480px] max-w-7xl items-center px-6 py-20">
          ...
          >
            ...
            <h1 className="mt-6 text-5xl font-black leading-tight tracking-tight sm:text-6xl">
              Soya Processing & <span className="text-lime-400">Protein Extraction</span>
            </h1>

            <p className="mt-6 text-lg text-slate-200 leading-8">
              High-quality soybean processing delivering premium de-oiled cake (DOC) and soya meal essential for balanced poultry and livestock feed formulations.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black text-slate-900 sm:text-5xl">
              Premium Soya Meal & De-Oiled Cake
            </h2>
            <p className="mt-6 text-slate-600 leading-8 text-base">
              Urja Soya Processing uses solvent extraction and steam conditioning to supply pure soya DOC rich in crude protein and essential amino acids.
            </p>

            <div className="mt-8 space-y-4">
              {[
                "46-48% High Crude Protein Soya DOC",
                "Advanced Solvent Extraction & Conditioning",
                "Optimum Lysine & Methionine Profile for Poultry",
                "Low Urease Activity & High Digestibility",
              ].map((item, idx) => (
          ...
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 shadow-2xl">
            <img
              src="https://www.urjafoods.net/wp-content/uploads/2021/08/soyaa-480x367.jpg"
              alt="Soya Meal"
