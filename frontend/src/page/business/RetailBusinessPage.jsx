    ...
    <div className="bg-white text-slate-900">
      <section className="relative min-h-[480px] overflow-hidden bg-[#eff8e6]">
        <div className="absolute inset-0">
          <img
            src="https://www.urjafoods.net/wp-content/uploads/2025/08/plant-collage.webp"
            alt="Retail Network"
        ...
        <div className="relative mx-auto flex min-h-[480px] max-w-7xl items-center px-6 py-20">
          ...
          >
            <span className="inline-flex items-center gap-2 rounded-full border border-lime-400/30 bg-lime-500/20 px-4 py-2 text-xs font-extrabold uppercase tracking-widest text-lime-300 backdrop-blur-md">
              ...
              Direct Reach Division
            </span>

            <h1 className="mt-6 text-5xl font-black leading-tight tracking-tight sm:text-6xl">
              Retail & Distribution <span className="text-lime-400">Network</span>
            </h1>

            <p className="mt-6 text-lg text-slate-200 leading-8">
              Delivering farm-fresh eggs, quality poultry meat, cattle feeds, and bio-inputs directly to consumers and regional dealer networks.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black text-slate-900 sm:text-5xl">
              Connecting Farms Directly To Families & Dealers
            </h2>
            <p className="mt-6 text-slate-600 leading-8 text-base">
              Through strategic retail outlets and a network of over 100+ authorized dealers across Western Maharashtra, Urja ensures seamless access to farm products and feeds.
            </p>

            <div className="mt-8 space-y-4">
              {[
                "100+ Authorized Dealer & Retail Partners",
                "Farm Fresh Quality Eggs & Hygienic Poultry Outlets",
                "Direct-to-Farmer Feed Distribution Hubs",
                "Cold Chain Logistics & Quick Turnaround Delivery",
              ].map((item, idx) => (
                <div key={idx} className="flex items-center gap-3 p-4 bg-[#eff8e6] rounded-2xl border border-lime-100">
            ...
            <div className="mt-10">
              ...
              >
                Apply For Urja Dealership / Retail Outlet
          ...
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 shadow-2xl">
            <img
              src="https://www.urjafoods.net/wp-content/uploads/2021/08/retail-480x367.jpghttps://www.urjafoods.net/wp-content/uploads/2021/08/retail-480x367.jpg"
              alt="Retail Stores"
